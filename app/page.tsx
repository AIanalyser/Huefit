      ...
      <main className="flex-1">
        ...
        <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden px-6 pt-28 pb-20">
          ...
          <div
            ...
            style={{
              background:
                "radial-gradient(circle, rgba(196,170,145,0.35) 0%, transparent 70%)",
            }}
          />
          ...
          <div
            ...
            style={{
              background:
                "radial-gradient(circle, rgba(180,155,170,0.28) 0%, transparent 70%)",
            }}
          />
          ...
          <div
            ...
            style={{
              background:
                "radial-gradient(circle, rgba(210,190,160,0.3) 0%, transparent 70%)",
            }}
          />
          ...
          <div className="relative z-10 text-center max-w-3xl mx-auto">
            ...
            {/* Headline */}
            <h1
              className="mb-6 animate-fade-up delay-1"
              style={{ opacity: 0 }}
            >
              <span
            ...
            {/* CTA row */}
            <div
              className="flex flex-col sm:flex-row items-center justify-center gap-3 animate-fade-up delay-3"
              style={{ opacity: 0 }}
            >
              <Link
                href="/analyze"
            ...
            {/* Subtle tone strip */}
            <div
              className="flex items-center justify-center gap-1.5 mt-14 animate-fade-up delay-4"
              style={{ opacity: 0 }}
            >
              {[
                "#F7E7D3",
          ...
          <div className="absolute bottom-10 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 animate-soft-pulse">
            <div
              ...
              style={{
                background:
                  "linear-gradient(180deg, transparent, rgba(120,100,80,0.3))",
              }}
            />
        ...
        <section className="py-24 px-6">
          ...
          >
            ...
            <div
              ...
              style={{
                background:
                  "radial-gradient(circle, rgba(200,170,140,0.6) 0%, transparent 70%)",
              }}
            />
