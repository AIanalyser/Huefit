...
export default function ResultRightPanel({
  ...
  const hasImage = !!(
    generatedResult?.imageBase64 || generatedResult?.imageUrl
  );
  ...
  const handleShare = () => {
    shareResult(
      "My HueFit Look",
      "Check out my AI-personalised outfit!",
    ...
    <div className="space-y-5">
      ...
      <div>
        ...
        >
          <div className="flex justify-between">
            <span style={{ color: "#8A837C" }}>
              Format
            </span>

            <span className="font-medium">
              {generatedResult?.format ?? "PNG"}
            </span>
          </div>
      ...
      <div className="space-y-2">
        ...
        <button
          ...
          onMouseLeave={(e) =>
            (e.currentTarget.style.color = "#8A837C")
          }
        >
          Start Over
        </button>
