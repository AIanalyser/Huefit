...
export const useAnalysisStore = create<AnalysisState>()(
  persist(
    (set, get) => ({
      ...
      setGeneratedResult: (
        result: GeneratedOutfitResult | null
    ...
    {
      name: "huefit-analysis-store",

      // Files cannot be serialized into localStorage.
      // The uploaded image itself can still be persisted.
      partialize: (state) => ({
